        ...
        <section className="bg-white p-7 rounded-lg dark:bg-dark-600">
            <div className="h-full lg:w-9/12 xl:w-7/12 m-auto space-y-5">
                ...
                <form className="space-y-1.5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    />
                    <p className="text-red-600 text-sm py-1 h-6 dark:text-red-500">{errors.currentPassWord?.message}</p>
                    <Controller
                        name="newPassWord"
                        control={control}
                        defaultValue=""
                    ...
                    />
                    <p className="text-red-600 text-sm py-1 h-6 dark:text-red-500">{errors.confirmPassWord?.message}</p>
                    <Button className="my-10" type="submit" variant="fill" fullWidth loading={isLoadingAPI}>
                        {t('savePass')}
                    </Button>
                </form>
            </div>
