...
// ghosts
import GetProductsHot from '../../ghosts/GetProductsHot';
...
const NewProductsSection = () => {
    ...
    return (
        <>
            <GetProductsHot setProducts={setProducts} />
            <div className="w-10/12 flex flex-col justify-center m-auto my-8 gap-8">
                <div className="w-full grid justify-items-center gap-1">
                    ...
                    <div className="uppercase text-xl font-semibold not-italic">{t('hotProducts')}</div>
                </div>
